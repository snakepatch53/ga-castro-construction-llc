...
export default function InstantQuote() {
    return (
        <div className=" flex flex-col w-full items-center py-10  sm:gap-20 ">
            <h2 className="font-title text-5xl text-center pb-20 sm:py-5">
            ...
            <div className="flex flex-col lg:flex-row w-full gap-10">
                ...
                <div className="flex flex-1 flex-col items-center justify-center gap-5 sm:px-10">
                    <h3 className="font-title text-2xl text-center text-balance">
                        With our express system you can see access to a free quote!
                    </h3>
                    <div className="flex flex-col gap-2 sm:ml-20">
                    ...
                    <div className="flex w-full items-center justify-center pr-7 sm:pr-0 gap-2 sm:gap-10">
                        <span className="w-80  font-title text-center sm:text-lg text-white px-5 sm:px-10 py-2 rounded-bl-3xl rounded-tr-3xl sm:tracking-wider  bg-[#028bdb]">
...
function Item({ title, icon }) {
    return (
        <div className="flex w-full items-center gap-1 md:gap-5 ">
            ...
            <span className="flex w-full font-title text-balance text-start">{title}</span>
        </div>
    );
}
