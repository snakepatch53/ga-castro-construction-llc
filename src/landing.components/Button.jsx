...
export default function Button({ children = false, text = "", style = 1, type = 1, ...props }) {
    ...
    if (style == 1) {
        ...
        classStyle =
            "flex justify-center px-10 py-3 mx-auto mt-16 bg-[var(--color2-bg)] text-[var(--color2-txt)] text-md font-content font-bold tracking-widest rounded-full transition-all duration-300 gap-1 hover:gap-3 hover:scale-105";
    } else if (style == 4) {
        classStyle =
            "flex justify-center px-10 py-3 mx-auto mt-16 bg-[var(--color3-bg)] text-[var(--color3-txt)] text-md font-content font-bold tracking-widest rounded-full transition-all duration-300 gap-1 hover:gap-3 hover:scale-105";
    }
