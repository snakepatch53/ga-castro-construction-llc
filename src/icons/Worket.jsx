...
export default function Worket({ classWrapper = "" }) {
    return (
        <>
            <svg
                className={cls(classWrapper, "w-20")}
                fill="#000000"
                viewBox="0 0 100 100"
                id="Layer_1"
                version="1.1"
            ...
            >
                ...
                <g id="SVGRepo_iconCarrier">
                    {" "}
                    <g id="jackhammer"></g> <g id="drilling_machine"></g> <g id="hammer"></g>{" "}
                    <g id="measuring_tape"></g> <g id="wrench"></g> <g id="saw"></g>{" "}
                    <g id="building"></g> <g id="wall"></g> <g id="crane"></g>{" "}
                    <g id="barrier_sign"></g> <g id="concept"></g> <g id="shovel"></g>{" "}
                    <g id="architecture"></g> <g id="safety_helmet"></g>{" "}
                    <g id="worker">
                        {" "}
                        <g>
                            {" "}
                            <path d="M45.1,43c0.6,0,1-0.4,1-1c0-2.2-1.8-4-4-4s-4,1.8-4,4c0,0.6,0.4,1,1,1s1-0.4,1-1c0-1.1,0.9-2,2-2s2,0.9,2,2 C44.1,42.6,44.6,43,45.1,43z"></path>{" "}
                            <path d="M56,50.4c0.2-0.5,0-1.1-0.4-1.3c-0.5-0.2-1.1,0-1.3,0.4c-0.8,1.5-2.3,2.4-4.1,2.4s-3.4-0.9-4.1-2.4 c-0.2-0.5-0.8-0.7-1.3-0.4c-0.5,0.2-0.7,0.8-0.4,1.3c1.1,2.2,3.4,3.6,5.9,3.6S54.9,52.6,56,50.4z"></path>{" "}
                            <path d="M55.1,43c0.6,0,1-0.4,1-1c0-1.1,0.9-2,2-2s2,0.9,2,2c0,0.6,0.4,1,1,1s1-0.4,1-1c0-2.2-1.8-4-4-4s-4,1.8-4,4 C54.1,42.6,54.6,43,55.1,43z"></path>{" "}
                    ...
                    <g id="teamwork"></g> <g id="roller_brush"></g> <g id="designs"></g>{" "}
                    <g id="trolley"></g> <g id="pick_axe"></g>{" "}
                </g>
            </svg>
        </>
    );
