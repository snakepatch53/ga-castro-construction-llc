        ...
        <AnimatedElement>
                    ...
                    <div className="flex flex-col gap-10 md:flex-row md:gap-0 items-center ">
                        ...
                        <div className="flex-1">
                            <p className="font-title text-center md:text-start text-balance lg:pr-40">
                                Fire damage or smoke damage? Restoration Local
                                is the #1 network of restoration professions and
                                we have qualified fire damage restoration
                                contractors in your neighborhood. From kitchen
                                fires to furnace puffbacks, they Will clean
                                smoke and soot damage and restore your property
                                to its original condition. They even remove
                                water from fire fighting efforts and treat
                                against mold.
                            </p>
                        </div>
                    </div>
            ...
            <section className="relative  overflow-hidden px-[--padding]">
                <div className="container">
                    <h3 className="w-full text-center font-title text-5xl sm:text-6xl">
                        FIND ALL{" "}
                        <span className="text-[--color1-bg]">OUR SERVICES</span>
                    </h3>
            ...
            <section className="relative overflow-hidden px-[--padding] mt-20">
                <div className="container flex flex-col ">
                    <h3 className="w-full text-center font-title text-5xl sm:text-6xl">
                        WHY{" "}
                        <span className="text-[--color1-bg]">CHOOSE US?</span>
                    </h3>
                    <div className="flex flex-col lg:flex-row py-20">
                        <div className="flex-1 ">
                            <div className="flex flex-col font-title gap-8 text-3xl text-center sm:text-start opacity-80 pb-10 sm:pb-0">
                                <p>
                                    We are 24/7 Water and Mold Damage Emergency
                                    Response Team.
                                </p>
                                <p>
                                    We&apos;re a full-service restoration
                                    company specialized in Water Damage, Flood,
                                    Fire, Storm, Sewage, and Mold Remediation.
                                    We have over 14 years of experience in this
                                    industry and have helped thousands of home
                                    and business owners in restoring their
                                    property to pre-loss condition.
                                </p>
                                <p>
                                    We guarantee our work and have handpicked
                                    our staff so that we never lose that
                                    &quot;personal attention&quot; that you
                                    rarely receive in this industry today.
                                </p>
                                <p>
                                    We look forward to working with you and Will
                                    always provide professional and friendly
                                    service!
                                </p>
                            </div>
                        </div>
...
function Item({ src, title, to }) {
    return (
        <Link
            to={to}
            className="group flex-1 flex flex-col items-center gap-5 cursor-pointer"
        >
