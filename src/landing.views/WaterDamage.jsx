    ...
    return (
        <AnimatedElement>
            ...
            <section className="relative">
                <div className="container flex flex-col items-center gap-10 pt-10 md:px-20 p-[--padding] sm:translate-y-20">
                    <h3 className="font-title text-4xl sm:text-6xl text-center">
            ...
            <section className="relative">
                ...
                <div className="container w-full p-[var(--padding)] pt-40">
                    <SectionContact />
                </div>
            </section>
        </AnimatedElement>
